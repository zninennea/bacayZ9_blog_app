                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('posts.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="body" name="body" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" rows="8" required>{{ old('body') }}</textarea>
                        </div>
